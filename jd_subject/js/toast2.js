...
var toast = (function() {
    ...
    var currentScriptPath = document.scripts[document.scripts.length - 2].src;//获取当前脚本文件路径
    ...
    var tips = function(msg, calback) {
        $("body").append('<div id="shadow-box"><div id="shadow" style="width:' + (msg.length + 2) + 'em;margin-left:"+-(msg.length+2)/2++"em">' + msg + '</div></div>');
        // $("#shadow").css({"width": (msg.length + 2) + "em","marginLeft":-(msg.length+2)/2+"em"});
